...
package com.tangguna.rxhttputils.library;
import android.app.Application;
import android.content.Context;
import android.text.TextUtils;

import com.tangguna.rxhttputils.library.cache.RxCache;
import com.tangguna.rxhttputils.library.cache.converter.IDiskConverter;
import com.tangguna.rxhttputils.library.cache.converter.SerializableDiskConverter;
import com.tangguna.rxhttputils.library.cache.model.CacheMode;
import com.tangguna.rxhttputils.library.cookie.CookieManger;
import com.tangguna.rxhttputils.library.https.HttpsUtils;
import com.tangguna.rxhttputils.library.interceptor.HttpLoggingInterceptor;
import com.tangguna.rxhttputils.library.model.HttpHeaders;
import com.tangguna.rxhttputils.library.model.HttpParams;
import com.tangguna.rxhttputils.library.request.CustomRequest;
import com.tangguna.rxhttputils.library.request.DeleteRequest;
import com.tangguna.rxhttputils.library.request.DownloadRequest;
import com.tangguna.rxhttputils.library.request.GetRequest;
import com.tangguna.rxhttputils.library.request.PostRequest;
import com.tangguna.rxhttputils.library.request.PutRequest;
import com.tangguna.rxhttputils.library.utils.HttpLog;
import com.tangguna.rxhttputils.library.utils.RxUtil;
import com.tangguna.rxhttputils.library.utils.Utils;
...
public final class RxHttp {
     ...
     * 添加全局公共请求参数
     */
    public RxHttp addCommonParams(@Nullable HttpParams commonParams) {
     ...
     * 添加全局公共请求参数
     */
    public RxHttp addCommonHeaders(@Nullable HttpHeaders commonHeaders) {
